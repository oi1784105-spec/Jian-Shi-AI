...
class Settings(BaseSettings):
    ...
    MAIL_FROM_NAME: str = "JianShi AI"
    MAIL_ENCRYPTION: str = "none"

    # Brevo 配置
    BREVO_API_KEY: str = "dummy-api-key"
    BREVO_EMAIL_FROM: str = "noreply@example.com"
    BREVO_EMAIL_FROM_NAME: str = "JianShi AI"

    # 管理员邮箱
    ADMIN_EMAIL: str = "admin@jianshi-ai.local"
    ADMIN_PASSWORD: str = ""
    ...
    # 资源配置（适合单机开发，可通过环境变量覆盖）
    DB_POOL_SIZE: int = 5
    DB_MAX_OVERFLOW: int = 5
    CELERY_WORKER_CONCURRENCY: int = 2
    CELERY_DEMO_TASKS_ENABLED: bool = False
