...
class Interview(BaseModel):
    ...
    ai_provider_id = Column(Integer, ForeignKey("ai_provider_configs.id", ondelete="SET NULL"), nullable=True)
    ...
    ai_provider = relationship("AIProvider", back_populates="interviews")
