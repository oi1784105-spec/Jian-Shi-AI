...
# JianShi AI Production Environment Deployment Script
...
echo "🚀 Starting JianShi AI deployment..."
...
if [[ "$COMPOSE_FILES" == *"docker-compose.prod.yml"* ]] && [[ -z "$IMAGE_TAG" ]]; then
    ...
    export IMAGE_TAG="ghcr.io/your-github-username/jianshi-ai-app:latest"
fi
